...
/**
 * Process Line — Major process line (thick solid line).
 * ISA standard: heavy-weight solid line for main process piping.
 */
const ProcessLine: React.FC<SymbolProps> = ({
  size = 48,
  state = 'active',
  color,
  label,
  ...
  return (
    <svg
      ...
      className={`pid-line pid-process-line ${isFault ? 'pid-fault-flash' : ''} ${className}`}
      onClick={onClick}
    ...
    >
      ...
      <g transform={`rotate(${rotation} 24 24)`}>
        ...
        />
        {animated && (
          <circle r="3" fill={fill} opacity="0.6">
