...
/**
 * Globe Valve — ISA 5.1 Standard
 * Two triangles meeting at center with a circle overlaid at the junction.
 * The circle distinguishes it from a gate valve.
 */
const GlobeValve: React.FC<SymbolProps> = ({
  size = 48,
  state = 'open',
  color,
  label,
  ...
  return (
    <svg
      ...
      className={`pid-valve pid-globe-valve ${isFault ? 'pid-fault-flash' : ''} ${isTransit ? 'pid-transit-pulse' : ''} ${className}`}
      onClick={onClick}
    ...
    >
      ...
      <g transform={`rotate(${rotation} 24 24)`}>
        ...
        {/* Globe circle at center — distinguishing feature */}
        <circle
          cx="24"
          cy="24"
          r="5"
        ...
        <line x1="24" y1="19" x2="24" y2="10" stroke={fill} strokeWidth="2" strokeLinecap="round" />
