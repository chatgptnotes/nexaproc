...
/**
 * Butterfly Valve — ISA 5.1 Standard
 * Two triangles meeting at center with a vertical line through the center
 * representing the disc that rotates within the flow path.
 */
const ButterflyValve: React.FC<SymbolProps> = ({
  size = 48,
  state = 'open',
  color,
  label,
  ...
  return (
    <svg
      ...
      className={`pid-valve pid-butterfly-valve ${isFault ? 'pid-fault-flash' : ''} ${isTransit ? 'pid-transit-pulse' : ''} ${className}`}
      onClick={onClick}
    ...
    >
      ...
      <g transform={`rotate(${rotation} 24 24)`}>
        ...
        {/* Disc indicator — vertical line through center, extending above and below */}
        <line x1="24" y1="12" x2="24" y2="36" stroke={fill} strokeWidth="2.5" strokeLinecap="round" />

        {/* Small disc circle at center */}
